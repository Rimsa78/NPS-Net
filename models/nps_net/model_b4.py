...
Key properties:
    ...
    - Cup head: CupGateHead with shape prior fusion
...
This is essentially NPS-Net (before band-anchored disc head).

Changes from B3:
    - Add ShapePriorBranch
    - Add ConfidenceGatedFusion
    - Full staged training (Stage A → B → C) with all 7 loss terms

Changes from B5 (full model):
